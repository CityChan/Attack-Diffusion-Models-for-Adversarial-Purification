...
class SDE_Adv_Model(nn.Module):
    ...
    def forward(self, x):
        ...
        x_re = (x_re + 1) * 0.5
        save_imagenet(x_re.cpu().data, name='./adversarial_samples/iamgenet_diff.png')
...
def eval_autoattack(args, config, model, x_val, y_val, adv_batch_size, log_dir):
    ...
    save_imagenet(x_adv_resnet.cpu().data, name='./adversarial_samples/imagenet_adv.png')
    ...
    save_imagenet(x_adv_sde.cpu().data, name='./adversarial_samples/iamgenet_diffusion_adv.png')
